...
This document defines how `kaos-tabular` handles features, bugs,
...
- What `kaos-tabular` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_tabular`.
