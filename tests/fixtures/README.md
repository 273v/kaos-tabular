...
| `states.csv` | Vendored from `kelvin-modules/kelvin_tabular/samples/states/states.csv` (initial kelvin tabular commit `e8b7e1d`, 2025-05-10). Field-level data (capital, admission date, population, lat/lon, motto, descriptive summary) is compiled from public-domain US federal sources (census.gov, state.gov) and Wikipedia article excerpts | CC-BY-SA-4.0 for Wikipedia-derived prose excerpts in the `description` and `motto` columns; public domain (17 USC §105) for the underlying federal facts | 2026-04-03 (first KAOS commit `aef1072`) | `7b1a2c024dbc457e213e8b42b74a81b8109fbefb3fefeb8a4f1fca71e3827e71` |
| `states.json` | Re-serialization of `states.csv` to JSON-records by 273V (generated for kaos-tabular tests; hash differs from the kelvin upstream JSON) | CC-BY-SA-4.0 / public domain (mixed, same as `states.csv`); 273V derived representation | 2026-04-03 (first KAOS commit `aef1072`) | `121624ecbf36d83bdbf905e2a379a9350018b856aaef418ff02e2599f6726be2` |
| `states.xlsx` | Vendored from `kelvin-modules/kelvin_tabular/samples/states/states.xlsx` (initial kelvin tabular commit `e8b7e1d`, 2025-05-10); same data as `states.csv` | CC-BY-SA-4.0 / public domain (mixed, same as `states.csv`); 273V vendored representation | 2026-04-03 (first KAOS commit `e03b9b5`) | `3a4748fb80ebf1e381cfbfe979368132025ddf4823a3f68a73b9485c1f6edcbc` |
| `states.sqlite` | Vendored from `kelvin-modules/kelvin_tabular/samples/states/states.sqlite` (initial kelvin tabular commit `e8b7e1d`, 2025-05-10); same data as `states.csv` | CC-BY-SA-4.0 / public domain (mixed, same as `states.csv`); 273V vendored representation | 2026-04-03 (first KAOS commit `e03b9b5`) | `7d7166006612736e9ae12c89cf05f78932bf70b33c819a44725505245ab55dc3` |
...
documented in the per-row License column above per the policy's
case-by-case guidance for CC-BY-SA-4.0 fixtures.
